...
const STAGE_COLORS = [
    ...
    '#2E7D32', // Under Contract
    '#43A047', // Marketing/Bulk In Progress
    '#66BB6A'  // Marketing/Bulk Complete
];
...
export default class ExecutiveDashboard extends LightningElement {
    ...
    get emaBulkLane() {
        return this._buildLane(this.data?.emaBulkForecast, 'Marketing/Bulk Forecast', 'Melissa Baker');
    }
