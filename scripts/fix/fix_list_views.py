"""
Create missing list views after cleanup.
Uses correct Metadata API filter format (OPPORTUNITY.RECORDTYPE / CUST_RECORDTYPE).
"""
...
def main():
    ...
    # Opportunity list views — MDU_Open already exists, need MDU_All, BUS_All, BUS_Open
...
<CustomObject xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    # Agreement list views — need MDU_All and BUS_All
    # Agreement__c may not have record types, so filter by parent Opportunity record type
    # Actually let's check if Agreement__c has a record type or link field
...
<CustomObject xmlns="http://soap.sforce.com/2006/04/metadata">
    <listViews>
        ...
        <filterScope>Everything</filterScope>
        <filters>
            <field>Agreement__c.RECORDTYPE</field>
            <operation>equals</operation>
            <value>Agreement__c.MDU</value>
        </filters>
        <sharedTo>
            <allInternalUsers></allInternalUsers>
        </sharedTo>
    ...
    <listViews>
        ...
        <filters>
            <field>Agreement__c.RECORDTYPE</field>
            <operation>equals</operation>
            <value>Agreement__c.Business</value>
        </filters>
        <sharedTo>
            <allInternalUsers></allInternalUsers>
        </sharedTo>
...
<Package xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    deploy_zip(session_id, buf.read(), "Create missing MDU/BUS list views")
