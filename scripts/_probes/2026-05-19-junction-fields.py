"""List Opportunity_Contact__c and Agreement__c field names."""
import os, sys, io
...
for obj in ('Opportunity_Contact__c', 'Agreement__c', 'SiteTracker_Project__c'):
    try:
